...
def test_default_worker_profile_loads_basic_batch_and_integrations_handlers() -> None:
    ...
    assert "polymarket.events.catalog_sync" in registry
    assert "polymarket.events.snapshot_sync" in registry
...
def test_basic_worker_profile_only_loads_basic_handlers() -> None:
    ...
    assert "polymarket.events.catalog_sync" not in registry
...
def test_integrations_worker_profile_only_loads_polymarket_handlers() -> None:
    registry = build_handler_registry(profile="integrations")
